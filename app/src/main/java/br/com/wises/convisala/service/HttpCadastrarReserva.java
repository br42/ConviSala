...
public class HttpCadastrarReserva extends AsyncTask<Void, Void, String> {
    @NonNull private String reserva;

    public HttpCadastrarReserva(@NonNull String reserva) {
    ...
    protected String doInBackground(Void... voids) {
        int responseCode = 0;
        String wsURL = Aplicativo.baseUrl + "reserva/cadastrar/";
        ...
        try {
            ...
            con.setRequestProperty("novaReserva", reserva);
